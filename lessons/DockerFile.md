...
- [Components in DockerFile](#components-in-dockerfile)
...
## Docker CLI Commands
- [Build](#1-build-an-image-from-dockerfile)
- [List Images](#2-list-images)
- [Run Container](#3-run-a-container)
- [Execute Commands](#4-execute-commands-inside-container)
- [Stop/Start Container](#5-stop--start-container)
- [Remove Container](#6-remove-container)
- [Remove Image](#7-remove-image)
- [View Logs](#8-view-logs)
- [Rebuild After Changes](#9-rebuild-after-changes)
- [Using Docker Compose](#10-using-docker-compose-recommended)
